...
class wifi(gr.top_block, Qt.QWidget):
    ...
    def set_wifi_freq(self, wifi_freq):
        self.wifi_freq = wifi_freq
        self.osmosdr_sink_0.set_center_freq(self.wifi_freq, 0)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(self.wifi_freq, self.samp_rate)
